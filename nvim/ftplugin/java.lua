...
local config = {
	...
	cmd = {
		"/Users/chrismichels/.sdkman/candidates/java/21.0.2-amzn/bin/java",
	...
	settings = {
		java = {
			...
			home = "/users/chrismichels/.sdkman/candidates/java/21.0.2-amzn/",
			eclipse = {
			...
			configuration = {
				...
				runtimes = {
					{
						name = "JavaSE-11",
						path = "/Users/chrismichels/.sdkman/candidates/java/11.0.22-amzn",
					},
					{
						name = "JavaSE-21",
						path = "/Users/chrismichels/.sdkman/candidates/java/21.0.2-amzn",
					},
				},
			},
			maven = {
